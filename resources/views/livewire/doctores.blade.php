       ...
       <div class="mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div class="bg-white doctor-card shadow-sm overflow-hidden mb-4">
            <div class="flex p-4">
               ...
               <img class="h-16 w-16 rounded-lg object-cover" src="https://images.unsplash.com/photo-1594824476967-48c8b964273f?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=80" alt="Dr. González">
                </div>
            ...
            Certificados
                ...
                <div class="flex items-center">
                   ...
                   <span style="color: #f6e05e;" class="border border-warning rounded-full px-2 py-0.5 font-semibold mr-2 text-sm"><i class="fas fa-star"></i> 4.8</span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white doctor-card shadow-sm overflow-hidden mb-4">
            <div class="flex p-4">
                <!-- Foto de perfil -->
                <div class="mr-4 flex-shrink-0">
                  <img class="h-16 w-16 rounded-lg object-cover" src="https://images.unsplash.com/photo-1622253692010-333f2da6031d?ixlib=rb-1.2.1&auto=format&fit=crop&w=200&h=200&q=80" alt="Dra. Rodríguez">
                </div>
