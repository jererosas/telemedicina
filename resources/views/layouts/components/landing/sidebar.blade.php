                        ...
                        <nav class="main-menu-container nav nav-pills sub-open">
                            ...
                            <div class="lg:flex hidden">
                                <div class="ti-btn-list ti-btn-sm lg:flex hidden mt-lg-2 mt-xl-0 mt-0">
                                    <a href="{{url('signup-basic')}}" class="ti-btn btn-wave bg-primarytint1color text-white">
                                        Sign Up
                                    </a>
                                    <a aria-label="anchor" href="javascript:void(0);"
                                        class="ti-btn m-0 p-2 px-3 ti-btn-primary ti-btn-icon btn-wave !font-medium"
