                ...
                <div class="container-fluid">
                    ...
                    <div class="flex items-center justify-between page-header-breadcrumb flex-wrap gap-2">
                        <div>
                            ...
                            <h1 class="page-title font-medium text-lg mb-0">File Manager</h1>
                        </div>
                        <div class="btn-list">
                            ...
                            <div class="grid grid-cols-12 gap-x-6">
                                <div class="xl:col-span-12 col-span-12">
                                    <div class="box">
                                        ...
                                        <div
                                            class="flex items-center gap-4 p-3 border-b border-dashed border-defaultborder dark:border-defaultborder/10">
                                            <span class="avatar avatar-xl online">
                                                <img src="{{asset('build/assets/images/faces/9.jpg')}}" alt="">
                                            </span>
                                            <div class="main-profile-info">
                                                <h6 class="font-semibold mb-1">Daniel David </h6>
                                                <p class="text-textmuted dark:text-textmuted/50 text-[11px] mb-2">Web
                                                    Designer</p>
                                        ...
                                        <div class="box-body !pt-0 !p-3">
                                            <ul class="list-none files-main-nav" id="files-main-nav">
                                                ...
                                                <li class="px-0 pt-0">
                                                    <span class="text-xs text-textmuted dark:text-textmuted/50">Most
                                                        Recent</span>
                                                </li>
                                                <li>
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        <div class="ms-auto">
                                                            <span
                                                                class="font-medium text-textmuted dark:text-textmuted/50">1.2KB</span>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="flex items-center gap-2">
                                                        <div class="me-0">
                                                            <span
                                                                class="avatar avatar-md bg-primarytint1color/10 !text-primarytint1color">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    viewBox="0 0 256 256">
                                                                    <rect width="256" height="256" fill="none" />
                                                                    <path
                                                        ...
                                                        <div class="ms-auto">
                                                            <span
                                                                class="font-medium text-textmuted dark:text-textmuted/50">25GB</span>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="flex items-center gap-2">
                                                        <div class="me-0">
                                                            <span
                                                                class="avatar avatar-md bg-primarytint2color/10 !text-primarytint2color">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    viewBox="0 0 256 256">
                                                                    <rect width="256" height="256" fill="none" />
                                                                    <path
                                                        ...
                                                        <div class="ms-auto">
                                                            <span
                                                                class="font-medium text-textmuted dark:text-textmuted/50">36GB</span>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="px-0 pt-3">
                                                    <span class="text-xs text-textmuted dark:text-textmuted/50">Upload
                                                        File</span>
                                                </li>
                                                <li
                                    ...
                                    <div class="file-manager-folders">
                                        ...
                                        <div class="p-4 file-folders-container">
                                            <div class="flex mb-4 items-center justify-between">
                                                <p class="mb-0 font-medium text-[14px]">Quick Access</p>
                                                <a href="javascript:void(0);"
                                                    class="text-xs text-textmuted dark:text-textmuted/50 font-medium"> View
                                                    All<i class="ti ti-arrow-narrow-right ms-1"></i> </a>
                                            </div>
                                            <div class="grid grid-cols-12 sm:gap-x-6 mb-3">
                                                <div
                                                    class="xxl:col-span-4 xl:col-span-6 lg:col-span-6 md:col-span-6 col-span-12">
                                                    <div
                                                        ...
                                                        <div class="box-body">
                                                            <div class="flex items-center gap-4 flex-wrap">
                                                                <div class="main-card-icon primary">
                                                                    <div
                                                                        class="avatar avatar-md bg-primary/10 border border-primary/10">
                                                                ...
                                                                <div class="flex-auto">
                                                                    <a href="javascript:void(0);"
                                                                        class="block font-medium">Images</a>
                                                                    <span
                                                                        class="text-xs text-textmuted dark:text-textmuted/50">17%
                                                                        Used</span>
                                                                </div>
                                                                <div class="text-end">
                                                                    <span class="font-medium">245 files</span>
                                                                    <span
                                                                        class="block text-xs text-textmuted dark:text-textmuted/50">26.14GB</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="box-body">
                                                            <div class="flex items-center gap-4 flex-wrap">
                                                                <div class="main-card-icon primary1">
                                                                    <div
                                                                        class="avatar avatar-md bg-primarytint1color/10 border border-primarytint1color/10">
                                                                        <div
                                                                            class="avatar avatar-sm !text-primarytint1color">
                                                                ...
                                                                <div class="flex-auto">
                                                                    <a href="javascript:void(0);"
                                                                        class="block font-medium">Videos</a>
                                                                    <span
                                                                        class="text-xs text-textmuted dark:text-textmuted/50">22%
                                                                        Used</span>
                                                                </div>
                                                                <div class="text-end">
                                                                    <span class="font-medium">224 files</span>
                                                                    <span
                                                                        class="block text-xs text-textmuted dark:text-textmuted/50">24.32GB</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="box-body">
                                                            <div class="flex items-center gap-4 flex-wrap">
                                                                <div class="main-card-icon primary2">
                                                                    <div
                                                                        class="avatar avatar-md bg-primarytint2color/10 border border-primarytint2color/10">
                                                                        <div
                                                                            class="avatar avatar-sm !text-primarytint2color">
                                                                ...
                                                                <div class="flex-auto">
                                                                    <a href="javascript:void(0);"
                                                                        class="block font-medium">Audio</a>
                                                                    <span
                                                                        class="text-xs text-textmuted dark:text-textmuted/50">24%
                                                                        Used</span>
                                                                </div>
                                                                <div class="text-end">
                                                                    <span class="font-medium">1354 files</span>
                                                                    <span class="block text-xs font-medium">29.45GB</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="box-body">
                                                            <div class="flex items-center gap-4 flex-wrap">
                                                                <div class="main-card-icon primary3">
                                                                    <div
                                                                        class="avatar avatar-md bg-primarytint3color/10 border border-primarytint3color/10">
                                                                        <div
                                                                            class="avatar avatar-sm !text-primarytint3color">
                                                                ...
                                                                <div class="flex-auto">
                                                                    <a href="javascript:void(0);"
                                                                        class="block font-medium">Apps</a>
                                                                    <span
                                                                        class="text-xs text-textmuted dark:text-textmuted/50">46%
                                                                        Used</span>
                                                                </div>
                                                                <div class="text-end">
                                                                    <span class="font-medium">18 files</span>
                                                                    <span
                                                                        class="block text-xs text-textmuted dark:text-textmuted/50">54.14GB</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="box-body">
                                                            <div class="flex items-center gap-4 flex-wrap">
                                                                <div class="main-card-icon info">
                                                                    <div
                                                                        class="avatar avatar-md bg-info/10 border border-info/10">
                                                                ...
                                                                <div class="flex-auto">
                                                                    <a href="javascript:void(0);"
                                                                        class="block font-medium">Docs</a>
                                                                    <span
                                                                        class="text-xs text-textmuted dark:text-textmuted/50">18%
                                                                        Used</span>
                                                                </div>
                                                                <div class="text-end">
                                                                    <span class="font-medium">102 files</span>
                                                                    <span
                                                                        class="block text-xs text-textmuted dark:text-textmuted/50">8.42GB</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="box-body">
                                                            <div class="flex items-center gap-4 flex-wrap">
                                                                <div class="main-card-icon secondary">
                                                                    <div
                                                                        class="avatar avatar-md bg-secondary/10 border border-secondary/10">
                                                                ...
                                                                <div class="flex-auto">
                                                                    <a href="javascript:void(0);"
                                                                        class="block font-medium">Downloads</a>
                                                                    <span
                                                                        class="text-xs text-textmuted dark:text-textmuted/50">16%
                                                                        Used</span>
                                                                </div>
                                                                <div class="text-end">
                                                                    <span class="font-medium">16 files</span>
                                                                    <span
                                                                        class="block text-xs text-textmuted dark:text-textmuted/50">6.36GB</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="flex mb-4 items-center justify-between">
                                                <p class="mb-0 font-medium text-[14px]">Folders</p>
                                                <a href="javascript:void(0);"
                                                    class="text-xs text-textmuted dark:text-textmuted/50 font-medium"> View
                                                    All<i class="ti ti-arrow-narrow-right ms-1"></i> </a>
                                            </div>
                                ...
                                <div class="box-body">
                                    <div class="filemanager-upgrade-storage w-full text-center">
                                        <span class="block mb-3 pb-1 bg-primarytint1color/10 rounded-2"> <img
                                                src="{{asset('build/assets/images/media/file-manager/2.png')}}" alt="" class="!inline-flex">
                                        </span>
                                        <span class="text-[1rem] font-semibold text-defaulttextcolor">Get more storage with
                                            Pro.</span>
                                        <span class="block text-textmuted dark:text-textmuted/50 mt-2">Upgrade now for
                                            increased storage space and enhanced functionality.</span>
                                        <div class="mt-4 grid"> <button
                                                class="ti-btn ti-btn-lg ti-btn-primary btn-wave waves-effect waves-light">Upgrade
                                                Now</button>
                                        </div>
                                    </div>
                                </div>
