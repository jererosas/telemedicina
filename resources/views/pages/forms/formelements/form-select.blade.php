                ...
                <div class="container-fluid">
                    ...
                    <div class="flex items-center justify-between page-header-breadcrumb flex-wrap gap-2">
                        <div>
                            ...
                            <h1 class="page-title font-medium text-lg mb-0">Form Select</h1>
                        </div>
                        <div class="btn-list">
                    ...
                    <div class="grid grid-cols-12 gap-x-6">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                            <label class="ti-form-select  rounded-sm !p-0 mb-2 font-medium">Default Choices Select</label>
                            ...
                            <label class="ti-form-select  rounded-sm !p-0 mb-2 font-medium">Option groups</label>
                    ...
                    <div class="grid grid-cols-12 gap-x-6">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                            <label class="ti-form-select rounded-sm !p-0 mb-2 font-medium">Default Single Choices Select</label>
                    ...
                    <div class="grid grid-cols-12 gap-x-6">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                            <label for="hs-select-label" class="ti-form-select rounded-sm !p-0 mb-2 font-medium">Label</label>
                        ...
                        <div class="box">
                            ...
                            <div class="space-y-3">
                                <div>
                                <label for="select-1" class="ti-form-select rounded-sm !p-0 mb-2 font-medium">Label</label>
                                <div class="relative">
                                    ...
                                    <svg class="h-4 w-4 text-danger" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                                    </svg>
                                    </div>
                                </div>
                                <p class="text-sm text-danger mt-2">Please select a valid state.</p>
                                </div>
            
                                <div>
                                <label for="select-2" class="ti-form-select rounded-sm !p-0 mb-2 font-medium">Label</label>
                                <div class="relative">
                                    ...
                                    <div class="absolute inset-y-0 end-0 flex items-center pointer-events-none pe-8">
                                    <svg class="h-4 w-4 text-success" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <p class="text-sm text-success mt-2">Looks good!</p>
                                </div>
                            </div>
                            </div>
                        </div>
