            ...
            <div class="container-fluid">
                ...
                <div class="flex items-center justify-between page-header-breadcrumb flex-wrap gap-2">
                    <div>
                        ...
                        <h1 class="page-title font-medium text-lg mb-0">Select2</h1>
                    </div>
                    <div class="btn-list">
                ...
                <div class="alert alert-primary alert-dismissible !text-[0.9375rem] fade show mb-4 !rounded-md flex items-center justify-between"
                    id="dismiss-alertremove">
                    <div class="!text-[0.9375rem]">
                        We Placed <strong class="text-secondary underline">Select2</strong> only in this page by using <strong
                            class="text-secondary underline">jquery</strong> cdn link.
                    </div>
                    <button type="button"
                        ...
                        <div class="box custom-box">
                            ...
                            <div class="box-body">
                                <select class="js-example-placeholder-multiple w-full js-states" multiple>
                                    <option value="fr-1">Alaska</option>
                                    <option value="fr-2">Arizona</option>
                                    <option value="fr-3">California</option>
                                    <option value="fr-4">Georgia</option>
                                    <option value="fr-5">Hawaii</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="xl:col-span-6 col-span-12">
                        <div class="box custom-box">
                            ...
                            <div class="box-body flex flex-col gap-3">
                                ...
                                <div>
                                    <button type="button" class="ti-btn ti-btn-soft-primary js-programmatic-enable">Enable</button>
                                    <button type="button" class="ti-btn ti-btn-primary js-programmatic-disable">Disable</button>
                                </div>
                            </div>
                        </div>
                    </div>
