            ...
            <div class="container-fluid">
                ...
                <div class="flex items-center justify-between page-header-breadcrumb flex-wrap gap-2">
                    <div>
                        ...
                        <h1 class="page-title font-medium text-lg mb-0">List Group</h1>
                    </div>
                    <div class="btn-list">
    ...
    &lt;/ul&gt;</code></pre>
                    ...
                    <div class="xl:col-span-6 col-span-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <ul class="ti-list-group">
                                    <li class="ti-list-group-item disabled" aria-disabled="true">A disabled item meant
                                        to be disabled
                                    </li>
                                    ...
                                    <li class="ti-list-group-item">Written in 45 BC. This book is a treatise on the
                                        theory</li>
                                </ul>
                            </div>
                            <div class="box-footer hidden border-t-0">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <ul class="ti-list-group ti-list-group-flush">
                                    <li class="ti-list-group-item !border-t-0 !border-l-0 !border-r-0 font-semibold"><i
                                            class="bi bi-envelope align-middle me-2 text-[#8c9097] dark:text-white/50"></i>Asish
                                        Trivedhi<span
                                            class="ms-1 text-[#8c9097] dark:text-white/50 font-normal inline-block">(+1023-84534)</span>
                                    </li>
                                    <li class="ti-list-group-item !border-l-0 !border-r-0  font-semibold"><i
                                            class="bi bi-tiktok align-middle me-2 text-[#8c9097] dark:text-white/50"></i>Alezander
                                        Russo<span
                                            class="ms-1 text-[#8c9097] dark:text-white/50 font-normal inline-block">(+7546-12342)</span>
                                    </li>
                                    <li class="ti-list-group-item !border-l-0 !border-r-0  font-semibold"><i
                                            class="bi bi-whatsapp align-middle me-2 text-[#8c9097] dark:text-white/50"></i>Karem
                                        Smith<span
                                            class="ms-1 text-[#8c9097] dark:text-white/50 font-normal inline-block">(+9944-56632)</span>
                                    </li>
                                    <li class="ti-list-group-item !border-l-0 !border-r-0  font-semibold"><i
                                            class="bi bi-facebook align-middle me-2 text-[#8c9097] dark:text-white/50"></i>Melissa
                                        Brien<span
                                            class="ms-1 text-[#8c9097] dark:text-white/50 font-normal inline-block">(+1023-34323)</span>
                                    </li>
                                    <li class="ti-list-group-item !border-l-0 !border-r-0 !border-b-0  font-semibold"><i
                                            class="bi bi-instagram align-middle me-2 text-[#8c9097] dark:text-white/50"></i>Kamala
                                        Harris<span
                                            class="ms-1 text-[#8c9097] dark:text-white/50 font-normal inline-block">(+91-63421)</span>
                                    </li>
                                </ul>
                            </div>
                            <div class="box-footer hidden border-t-0">
                                ...
                                <div class="ti-list-group">
                                    <ul class="list-none">
                                        <li class="ti-list-group-item ti-list-group-item-action active">
                                            <a href="javascript:void(0);" aria-current="true">
                                                <div class="flex items-center">
                                                    <div>
                                                        <span
                                                            class="avatar avatar-xs bg-white dark:bg-bodybg !text-defaulttextcolor avatar-rounded">
                                                            C
                                                        </span>
                                                    </div>
                                        ...
                                        <li
                                            class="ti-list-group-item ti-list-group-item-action hover:bg-gray-200 dark:hover:bg-light">
                                            <a href="javascript:void(0);" class="">
                                                <div class="flex items-center">
                                                    <div>
                                                        <span
                                                            class="avatar avatar-xs bg-secondary text-white avatar-rounded">
                                                            N
                                                        </span>
                                                    </div>
                                        ...
                                        <li
                                            ...
                                            <a href="javascript:void(0);" class="">
                                                <div class="flex items-center">
                                                    <div>
                                                        <span
                                                            class="avatar avatar-xs bg-info text-white avatar-rounded">
                                                            L
                                                        </span>
                                                    </div>
                                        ...
                                        <li
                                            ...
                                            <a href="javascript:void(0);" class="">
                                                <div class="flex items-center">
                                                    <div>
                                                        <span
                                                            class="avatar avatar-xs bg-warning text-white avatar-rounded">
                                                            M
                                                        </span>
                                                    </div>
                                        ...
                                        <li class="ti-list-group-item ti-list-group-item-action disabled">
                                            <a class=" ">
                                                <div class="flex items-center">
                                                    <div>
                                                        <span
                                                            class="avatar avatar-xs bg-success text-white avatar-rounded">
                                                            W
                                                        </span>
                                                    </div>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="ti-list-group flex flex-col">
                                    <button type="button"
                                        class="ti-list-group-item text-start ti-list-group-item-action active"
                                        aria-current="true">Simply dummy text of the printing<span
                                            class="badge ltr:float-right rtl:float-left bg-primary text-white">243</span></button>
                                    <button type="button"
                                        class="ti-list-group-item text-start ti-list-group-item-action">There are many
                                        variations of passages<span
                                            class="badge ltr:float-right rtl:float-left bg-secondary/10 text-secondary">35</span></button>
                                    <button type="button"
                                        class="ti-list-group-item text-start ti-list-group-item-action">All the Lorem
                                        Ipsum generators<span
                                            class="badge ltr:float-right rtl:float-left bg-info/10 text-info">132</span></button>
                                    <button type="button"
                                        class="ti-list-group-item text-start ti-list-group-item-action">All the Lorem
                                        Ipsum generators<span
                                            class="badge ltr:float-right rtl:float-left bg-success/10 text-success">2525</span></button>
                                    <button type="button"
                                        class="ti-list-group-item text-start ti-list-group-item-action" disabled>A
                                        disabled item meant to be disabled<span
                                            class="badge ltr:float-right rtl:float-left bg-danger/10 text-danger">21</span></button>
                                </div>
                            </div>
                            <div class="box-footer hidden border-t-0">
                                <!-- Prism Code -->
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <ul class="ti-list-group">
                                    ...
                                    <li class="ti-list-group-item !bg-light/10 !text-defaulttextcolor">A simple light
                                        list group
                                        item
                                    </li>
                                    <li class="ti-list-group-item !bg-black/10 dark:!bg-light !text-defaulttextcolor">A
                                        simple dark list group
                                        item
                                    </li>
                                </ul>
                            </div>
    ...
    &lt;/ul&gt;</code></pre>
                    ...
                    <div class="xl:col-span-6 col-span-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="ti-list-group flex flex-col">
                                    <a href="javascript:void(0);" class="w-full ti-list-group-item">A simple default
                                        list group item</a>
                                    <a href="javascript:void(0);"
                                        class="w-full ti-list-group-item !bg-primary/10 !text-primary hover:!bg-primary/20">A
                                        simple primary list group item</a>
                                    <a href="javascript:void(0);"
                                        class="w-full ti-list-group-item !bg-secondary/10 !text-secondar hover:!bg-secondary/20">A
                                        simple secondary list group item</a>
                                    <a href="javascript:void(0);"
                                        class="w-full ti-list-group-item !bg-success/10 !text-success hover:!bg-success/20">A
                                        simple success list group item</a>
                                    <a href="javascript:void(0);"
                                        class="w-full ti-list-group-item !bg-danger/10 !text-danger hover:!bg-danger/20">A
                                        simple danger list group item</a>
                                    <a href="javascript:void(0);"
                                        class="w-full ti-list-group-item !bg-warning/10 !text-warning hover:!bg-warning/20">A
                                        simple warning list group item</a>
                                    <a href="javascript:void(0);"
                                        class="w-full ti-list-group-item !bg-info/10 !text-info hover:!bg-info/20">A
                                        simple info list group item</a>
                                    <a href="javascript:void(0);"
                                        class="w-full ti-list-group-item !bg-light/10 !text-defaulttextcolor hover:!bg-light/20">A
                                        simple light list group item</a>
                                    <a href="javascript:void(0);"
                                        class="w-full ti-list-group-item !bg-black/10 dark:!bg-light !text-defaulttextcolor hover:!bg-black/20">A
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <ul class="ti-list-group ">
                                    ...
                                    <li class="ti-list-group-item !bg-primary !text-white !border-primary">A simple
                                        primary list
                                        group
                                        item</li>
                                    <li class="ti-list-group-item !bg-secondary !text-white !border-secondary">A simple
                                        secondary
                                        list
                                        group item</li>
                                    <li class="ti-list-group-item !bg-success !text-white !border-success">A simple
                                        success list
                                        group
                                        item</li>
                                    <li class="ti-list-group-item !bg-danger !text-white !border-danger">A simple danger
                                        list
                                        group
                                        item</li>
                                    <li class="ti-list-group-item !bg-warning !text-white !border-warning">A simple
                                        warning list
                                        group
                                        item</li>
                                    <li class="ti-list-group-item !bg-info !text-white !border-info">A simple info list
                                        group
                                        item
                                    </li>
                                    ...
                                    <li
                                        class="ti-list-group-item !bg-black dark:!bg-white dark:!text-black !text-white !border-black">
                                ...
                                <div class="ti-list-group">
                                    <ul class="list-none">
                                        <li class="ti-list-group-item ti-list-group-item-action active">
                                            <a href="javascript:void(0);" aria-current="true">
                                                <div class="sm:flex w-full justify-between">
                                                    <h6 class="mb-1 font-semibold !text-white">Web page editors now use
                                                        Lorem Ipsum?</h6>
                                                    <small>3 days ago</small>
                                                </div>
                                                <p class="mb-1">There are many variations of passages of Lorem Ipsum
                                        ...
                                        <li class="ti-list-group-item ti-list-group-item-action ">
                                            <a href="javascript:void(0);">
                                                <div class="flex w-full justify-between">
                                                    <h6 class="mb-1 font-semibold">Richard McClintock, a Latin
                                                        professor?</h6>
                                                    <small class="text-[#8c9097] dark:text-white/50">4 hrs ago</small>
                                                </div>
                                                <p class="mb-1">Contrary to popular belief, Lorem Ipsum is not simply
                                        ...
                                        <li class="ti-list-group-item ti-list-group-item-action ">
                                            <a href="javascript:void(0);">
                                                <div class="sm:flex w-full justify-between">
                                                    <h6 class="mb-1 font-semibold">It uses a dictionary of over 200
                                                        Latin words?</h6>
                                                    <small class="text-[#8c9097] dark:text-white/50">15 hrs ago</small>
                                                </div>
                                                <p class="mb-1">Lorem Ipsum has been the industry's standard dummy text
                                        ...
                                        <li class="ti-list-group-item ti-list-group-item-action ">
                                            <a href="javascript:void(0);">
                                                <div class="sm:flex w-full justify-between">
                                                    <h6 class="mb-1 font-semibold">The standard Lorem Ipsum used since
                                                        the 1500s?</h6>
                                                    <small class="text-[#8c9097] dark:text-white/50">45 mins ago</small>
                                                </div>
                                                <p class="mb-1">All the Lorem Ipsum generators on the Internet tend to
                                ...
                                <ol class="ti-list-group !list-decimal">
                                    <li class="ti-list-group-item flex justify-between items-start">
                                        <div class="ms-2 me-auto text-[#8c9097] dark:text-white/50">
                                            <div class="font-semibold text-[.875rem] !text-defaulttextcolor">What
                                                Happened?</div>
                                    ...
                                    <li class="ti-list-group-item flex justify-between items-start">
                                        <div class="ms-2 me-auto text-[#8c9097] dark:text-white/50">
                                            <div class="font-semibold text-[.875rem] !text-defaulttextcolor">It Was
                                                Amazing!</div>
                                    ...
                                    <li class="ti-list-group-item flex justify-between items-start">
                                        <div class="ms-2 me-auto text-[#8c9097] dark:text-white/50">
                                            <div class="font-semibold text-[.875rem] !text-defaulttextcolor">News Is A
                                                Great Weapon.</div>
                                    ...
                                    <li class="ti-list-group-item flex justify-between items-start">
                                        <div class="ms-2 me-auto text-[#8c9097] dark:text-white/50">
                                            <div class="font-semibold text-[.875rem] !text-defaulttextcolor">majority
                                                have suffered.</div>
    ...
    &lt;/ul&gt;</code></pre>
                    ...
                    <div class="xl:col-span-6 col-span-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <ul class="ti-list-group">
                                    <li class="ti-list-group-item flex justify-between items-center font-semibold">
                                        Groceries
                                    ...
                                    <li class="ti-list-group-item flex justify-between items-center font-semibold">
                                        Books
                                        <span class="badge bg-light text-defaulttextcolor">New</span>
                                    </li>
                                    <li class="ti-list-group-item flex justify-between items-center font-semibold">
                                        Toys
