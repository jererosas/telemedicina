            ...
            <div class="container-fluid">
                ...
                <div class="flex items-center justify-between page-header-breadcrumb flex-wrap gap-2">
                    <div>
                        ...
                        <h1 class="page-title font-medium text-lg mb-0">Dropdowns</h1>
                    </div>
                    <div class="btn-list">
                            ...
                            <div class="box-body">
                                <div class="ti-btn-list flex align-center flex-wrap">
                                    ...
                                    <div class="hs-dropdown ti-dropdown">
                                        <a class="ti-btn btn-wave  ti-btn-secondary ti-dropdown-toggle !py-2"
...
&lt;/div&gt;</code></pre>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="ti-btn-list">
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button class="ti-btn btn-wave  ti-btn-primary ti-dropdown-toggle"
                                                type="button" id="dropdownMenuButton2" aria-expanded="false">
                                                Action<i
                                                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button class="ti-btn btn-wave  ti-btn-secondary ti-dropdown-toggle"
                                                type="button" id="dropdownMenuButton3" aria-expanded="false">
                                                Action<i
                                                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button class="ti-btn btn-wave  ti-btn-success ti-dropdown-toggle"
                                                type="button" id="dropdownMenuButton4" aria-expanded="false">
                                                Action<i
                                                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button class="ti-btn btn-wave  ti-btn-info ti-dropdown-toggle"
                                                type="button" id="dropdownMenuButton5" aria-expanded="false">
                                                Action<i
                                                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button class="ti-btn btn-wave  ti-btn-warning ti-dropdown-toggle"
                                                type="button" id="dropdownMenuButton6" aria-expanded="false">
                                                Action<i
                                                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button class="ti-btn btn-wave  ti-btn-danger ti-dropdown-toggle"
                                                type="button" id="dropdownMenuButton7" aria-expanded="false">
                                                Action<i
                                                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
    ...
    &lt;div class="ti-btn-group"&gt;
        &lt;div class="hs-dropdown ti-dropdown"&gt;
            &lt;button class="ti-btn btn-wave  ti-btn-primary ti-dropdown-toggle" type="button"
    ...
    &lt;div class="ti-btn-group"&gt;
        &lt;div class="hs-dropdown ti-dropdown"&gt;
            &lt;button class="ti-btn btn-wave  ti-btn-success ti-dropdown-toggle" type="button"
                id="dropdownMenuButton1"
                aria-expanded="false"&gt;
                Action&lt;i
                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"&gt;&lt;/i&gt;
    ...
    &lt;div class="ti-btn-group"&gt;
        &lt;div class="hs-dropdown ti-dropdown"&gt;
            &lt;button class="ti-btn btn-wave  ti-btn-info ti-dropdown-toggle" type="button"
                id="dropdownMenuButton1"
                aria-expanded="false"&gt;
                Action&lt;i
                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"&gt;&lt;/i&gt;
    ...
    &lt;div class="ti-btn-group"&gt;
        &lt;div class="hs-dropdown ti-dropdown"&gt;
            &lt;button class="ti-btn btn-wave  ti-btn-warning ti-dropdown-toggle" type="button"
                id="dropdownMenuButton1"
                aria-expanded="false"&gt;
                Action&lt;i
                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"&gt;&lt;/i&gt;
    ...
    &lt;div class="ti-btn-group"&gt;
        &lt;div class="hs-dropdown ti-dropdown"&gt;
            &lt;button class="ti-btn btn-wave  ti-btn-danger ti-dropdown-toggle" type="button"
                id="dropdownMenuButton1"
                aria-expanded="false"&gt;
                Action&lt;i
                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"&gt;&lt;/i&gt;
...
&lt;/div&gt;</code></pre>
                            ...
                            <div class="box-body">
                                <div class="ti-btn-list">
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button
                                                class="ti-btn btn-wave  ti-btn-primary ti-dropdown-toggle !rounded-full"
                                                type="button" id="dropdownMenuButton8" aria-expanded="false">
                                                Action<i
                                                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button
                                                class="ti-btn btn-wave  ti-btn-secondary ti-dropdown-toggle !rounded-full"
                                                type="button" id="dropdownMenuButton9" aria-expanded="false">
                                                Action<i
                                                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button
                                                class="ti-btn btn-wave  ti-btn-success ti-dropdown-toggle !rounded-full"
                                                type="button" id="dropdownMenuButton11" aria-expanded="false">
                                                Action<i
                                                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button
                                                class="ti-btn btn-wave  ti-btn-info ti-dropdown-toggle !rounded-full"
                                                type="button" id="dropdownMenuButton10" aria-expanded="false">
                                                Action<i
                                                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button
                                                class="ti-btn btn-wave  ti-btn-warning ti-dropdown-toggle !rounded-full"
                                                type="button" id="dropdownMenuButton12" aria-expanded="false">
                                                Action<i
                                                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button
                                                class="ti-btn btn-wave  ti-btn-danger ti-dropdown-toggle !rounded-full"
                                                type="button" id="dropdownMenuButton13" aria-expanded="false">
                                                Action<i
                                                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
    ...
    &lt;div class="ti-btn-group !p-0 !border-0 !m-0"&gt;
        &lt;div class="hs-dropdown ti-dropdown"&gt;
            &lt;button class="ti-btn btn-wave  ti-btn-primary ti-dropdown-toggle !rounded-full"
                type="button" id="dropdownMenuButton1"
                aria-expanded="false"&gt;
                Action&lt;i
                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"&gt;&lt;/i&gt;
    ...
    &lt;div class="ti-btn-group !p-0 !border-0 !m-0"&gt;
        &lt;div class="hs-dropdown ti-dropdown"&gt;
            &lt;button class="ti-btn btn-wave  ti-btn-success ti-dropdown-toggle !rounded-full"
                type="button" id="dropdownMenuButton1"
                aria-expanded="false"&gt;
                Action&lt;i
                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"&gt;&lt;/i&gt;
    ...
    &lt;div class="ti-btn-group !p-0 !border-0 !m-0"&gt;
        &lt;div class="hs-dropdown ti-dropdown"&gt;
            &lt;button class="ti-btn btn-wave  ti-btn-info ti-dropdown-toggle !rounded-full"
                type="button" id="dropdownMenuButton1"
                aria-expanded="false"&gt;
                Action&lt;i
                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"&gt;&lt;/i&gt;
    ...
    &lt;div class="ti-btn-group !p-0 !border-0 !m-0"&gt;
        &lt;div class="hs-dropdown ti-dropdown"&gt;
            &lt;button class="ti-btn btn-wave  ti-btn-warning ti-dropdown-toggle !rounded-full"
                type="button" id="dropdownMenuButton1"
                aria-expanded="false"&gt;
                Action&lt;i
                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"&gt;&lt;/i&gt;
    ...
    &lt;div class="ti-btn-group !p-0 !border-0 !m-0"&gt;
        &lt;div class="hs-dropdown ti-dropdown"&gt;
            &lt;button class="ti-btn btn-wave  ti-btn-danger ti-dropdown-toggle !rounded-full"
                type="button" id="dropdownMenuButton1"
                aria-expanded="false"&gt;
                Action&lt;i
                    class="ri-arrow-down-s-line align-middle ms-1 inline-block"&gt;&lt;/i&gt;
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="xl:col-span-6 col-span-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="ti-btn-group !p-0 !mb-2 !m-0 !border-0 ti-dropdown hs-dropdown">
                                    <button class="ti-btn-primary ti-btn-lg ti-dropdown-toggle" type="button"
                                        aria-expanded="false">
                                ...
                                <div class="ti-btn-group !p-0 !mb-2 !m-0 !border-0">
                                    <div class="hs-dropdown ti-dropdown">
                                        <button
                                            class="ti-btn-lg ti-btn-light !border !border-defaultborder dark:!border-defaultborder/10 !me-0 !rounded-e-none ti-dropdown-toggle"
                                            type="button" id="dropdownMenuButton32" aria-expanded="false">
                                            Large split button
                                        </button>
                                        <button type="button" aria-label="button"
                                            class="ti-btn btn-wave  ti-btn-light opacity-[0.85] !border !border-defaultborder dark:!border-defaultborder/10 !rounded-s-none !m-0"><i
                                ...
                                <div class="ti-btn-group !p-0 !mb-2 !m-0 !border-0">
                                    <div class="ti-btn-group !p-0 !m-0 !border-0 ti-dropdown hs-dropdown">
                                        <button
                                            class="ti-btn btn-wave  ti-btn-primary !py-1 !px-4 !text-[0.75rem] ti-dropdown-toggle"
                                ...
                                <div class="ti-btn-group !p-0 !mb-2 !m-0 !border-0">
                                    <div class="hs-dropdown ti-dropdown">
                                        <button
                                            class="ti-btn btn-wave  !py-1 !px-4 !text-[0.75rem]  ti-btn-light !border !border-defaultborder  dark:!border-defaultborder/10 !me-0 !rounded-e-none ti-dropdown-toggle"
                                            type="button" id="dropdownMenuButton33" aria-expanded="false">
                                            Small split button
                                        </button>
                                        <button type="button" aria-label="button"
                                            class="ti-btn btn-wave  !py-1 !px-4 !text-[0.75rem] !border !border-defaultborder dark:!border-defaultborder/10 ti-btn-light opacity-[0.85] !rounded-s-none"><i
                                                class="ri-arrow-down-s-line align-middle inline-block"></i></button>
                            ...
                            <div class="box-footer hidden border-t-0">
                                <!-- Prism Code -->
                                <pre class="language-html"><code class="language-html"> &lt;div class="ti-btn-group !p-0 !m-0 !border-0 ti-dropdown hs-dropdown"&gt;
...
&lt;/ul&gt;
&lt;/div&gt;
&lt;div class="ti-btn-group !p-0 !m-0 !border-0"&gt;
&lt;div class="hs-dropdown ti-dropdown"&gt;
    &lt;button
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="ti-btn-list">
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button class="ti-btn btn-wave  ti-btn-outline-secondary ti-dropdown-toggle"
                                                type="button" id="dropdownMenuButton15" aria-expanded="false">
                                                Action<i class="ri-arrow-down-s-line align-middle inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button class="ti-btn btn-wave  ti-btn-outline-success ti-dropdown-toggle"
                                                type="button" id="dropdownMenuButton16" aria-expanded="false">
                                                Action<i class="ri-arrow-down-s-line align-middle inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button class="ti-btn btn-wave  ti-btn-outline-info ti-dropdown-toggle"
                                                type="button" id="dropdownMenuButton17" aria-expanded="false">
                                                Action<i class="ri-arrow-down-s-line align-middle inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button class="ti-btn btn-wave  ti-btn-outline-warning ti-dropdown-toggle"
                                                type="button" id="dropdownMenuButton18" aria-expanded="false">
                                                Action<i class="ri-arrow-down-s-line align-middle inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button class="ti-btn btn-wave  ti-btn-outline-danger ti-dropdown-toggle"
                                                type="button" id="dropdownMenuButton19" aria-expanded="false">
                                                Action<i class="ri-arrow-down-s-line align-middle inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                            ...
                            <div class="box-body">
                                <div class="ti-btn-list">
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button
                                                ...
                                                type="button" id="dropdownMenuButton20" aria-expanded="false">
                                                Action<i class="ri-arrow-down-s-line align-middle inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button
                                                ...
                                                type="button" id="dropdownMenuButton21" aria-expanded="false">
                                                Action<i class="ri-arrow-down-s-line align-middle inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button
                                                ...
                                                type="button" id="dropdownMenuButto22" aria-expanded="false">
                                                Action<i class="ri-arrow-down-s-line align-middle inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button
                                                class="ti-btn btn-wave  ti-btn-outline-info ti-dropdown-toggle !rounded-full"
                                                type="button" id="dropdownMenuButton23" aria-expanded="false">
                                                Action<i class="ri-arrow-down-s-line align-middle inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button
                                                ...
                                                type="button" id="dropdownMenuButton24" aria-expanded="false">
                                                Action<i class="ri-arrow-down-s-line align-middle inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button
                                                ...
                                                type="button" id="dropdownMenuButton25" aria-expanded="false">
                                                Action<i class="ri-arrow-down-s-line align-middle inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
...
&lt;/div&gt;</code></pre>
                                ...
                                <div class="ti-btn-list">
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="inline-flex">
                                            <button class="ti-btn btn-wave  ti-btn-primary !me-0 !rounded-e-none "
                                                type="button">
                                                Action
                                            </button>
                                            <div class="hs-dropdown ti-dropdown">
                                                <button type="button" aria-label="button"
                                                    class="ti-btn btn-wave  ti-btn-primary opacity-[0.85] !m-0 !rounded-s-none ti-dropdown-toggle"
                                                    id="dropdownMenuButton26" aria-expanded="false"><i
                                                        class="ri-arrow-down-s-line align-middle inline-block"></i></button>
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="inline-flex">
                                            <button class="ti-btn btn-wave  ti-btn-secondary !me-0 !rounded-e-none "
                                                type="button">
                                                Action
                                            </button>
                                            <div class="hs-dropdown ti-dropdown">
                                                <button type="button" aria-label="button"
                                                    class="ti-btn btn-wave  ti-btn-secondary opacity-[0.85] !m-0 !rounded-s-none ti-dropdown-toggle"
                                                    id="dropdownMenuButton27" aria-expanded="false"><i
                                                        class="ri-arrow-down-s-line align-middle inline-block"></i></button>
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="inline-flex">
                                            <button class="ti-btn btn-wave  ti-btn-success !me-0 !rounded-e-none "
                                                type="button">
                                                Action
                                            </button>
                                            <div class="hs-dropdown ti-dropdown">
                                                <button type="button" aria-label="button"
                                                    class="ti-btn btn-wave  ti-btn-success opacity-[0.85] !m-0 !rounded-s-none ti-dropdown-toggle"
                                                    id="dropdownMenuButton28" aria-expanded="false"><i
                                                        class="ri-arrow-down-s-line align-middle inline-block"></i></button>
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="inline-flex">
                                            <button class="ti-btn btn-wave  ti-btn-info !me-0 !rounded-e-none "
                                                type="button">
                                                Action
                                            </button>
                                            <div class="hs-dropdown ti-dropdown">
                                                <button type="button" aria-label="button"
                                                    class="ti-btn btn-wave  ti-btn-info opacity-[0.85] !m-0 !rounded-s-none ti-dropdown-toggle"
                                                    id="dropdownMenuButton50" aria-expanded="false"><i
                                                        class="ri-arrow-down-s-line align-middle inline-block"></i></button>
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="inline-flex">
                                            <button class="ti-btn btn-wave  ti-btn-warning !me-0 !rounded-e-none "
                                                type="button">
                                                Action
                                            </button>
                                            <div class="hs-dropdown ti-dropdown">
                                                <button type="button" aria-label="button"
                                                    class="ti-btn btn-wave  ti-btn-warning opacity-[0.85] !m-0 !rounded-s-none ti-dropdown-toggle"
                                                    id="dropdownMenuButton29" aria-expanded="false"><i
                                                        class="ri-arrow-down-s-line align-middle inline-block"></i></button>
                                    ...
                                    <div class="ti-btn-group !p-0 !border-0 !m-0">
                                        <div class="inline-flex">
                                            <button class="ti-btn btn-wave  ti-btn-danger !me-0 !rounded-e-none "
                                                type="button">
                                                Action
                                            </button>
                                            <div class="hs-dropdown ti-dropdown">
                                                <button type="button" aria-label="button"
                                                    class="ti-btn btn-wave  ti-btn-danger opacity-[0.85] !m-0 !rounded-s-none ti-dropdown-toggle"
                                                    id="dropdownMenuButton30" aria-expanded="false"><i
                                                        class="ri-arrow-down-s-line align-middle inline-block"></i></button>
    ...
    &lt;div class="ti-btn-group !p-0 !border-0 !m-0"&gt;
        &lt;div class="hs-dropdown ti-dropdown"&gt;
            &lt;button
                class="ti-btn btn-wave  ti-btn-primary !me-0 !rounded-e-none ti-dropdown-toggle"
                type="button" id="dropdownMenuButton1"
                aria-expanded="false"&gt;
                Action
            &lt;/button&gt;
            &lt;button
                class="ti-btn btn-wave  ti-btn-primary opacity-[0.85] !rounded-s-none"&gt;&lt;i
                    class="ri-arrow-down-s-line align-middle inline-block"&gt;&lt;/i&gt;&lt;/button&gt;
    ...
    &lt;div class="ti-btn-group !p-0 !border-0 !m-0"&gt;
        &lt;div class="hs-dropdown ti-dropdown"&gt;
            &lt;button
                class="ti-btn btn-wave  ti-btn-secondary !me-0 !rounded-e-none ti-dropdown-toggle"
                type="button" id="dropdownMenuButton1"
                aria-expanded="false"&gt;
                Action
            &lt;/button&gt;
            &lt;button
                class="ti-btn btn-wave  ti-btn-secondary opacity-[0.85] !rounded-s-none"&gt;&lt;i
                    class="ri-arrow-down-s-line align-middle inline-block"&gt;&lt;/i&gt;&lt;/button&gt;
    ...
    &lt;div class="ti-btn-group !p-0 !border-0 !m-0"&gt;
        &lt;div class="hs-dropdown ti-dropdown"&gt;
            &lt;button
                class="ti-btn btn-wave  ti-btn-success !me-0 !rounded-e-none ti-dropdown-toggle"
                type="button" id="dropdownMenuButton1"
                aria-expanded="false"&gt;
                Action
            &lt;/button&gt;
            &lt;button
                class="ti-btn btn-wave  ti-btn-success opacity-[0.85] !rounded-s-none"&gt;&lt;i
                    class="ri-arrow-down-s-line align-middle inline-block"&gt;&lt;/i&gt;&lt;/button&gt;
    ...
    &lt;div class="ti-btn-group !p-0 !border-0 !m-0"&gt;
        &lt;div class="hs-dropdown ti-dropdown"&gt;
            &lt;button
                class="ti-btn btn-wave  ti-btn-info !me-0 !rounded-e-none ti-dropdown-toggle"
                type="button" id="dropdownMenuButton1"
                aria-expanded="false"&gt;
                Action
            &lt;/button&gt;
            &lt;button
                class="ti-btn btn-wave  ti-btn-info opacity-[0.85] !rounded-s-none"&gt;&lt;i
                    class="ri-arrow-down-s-line align-middle inline-block"&gt;&lt;/i&gt;&lt;/button&gt;
    ...
    &lt;div class="ti-btn-group !p-0 !border-0 !m-0"&gt;
        &lt;div class="hs-dropdown ti-dropdown"&gt;
            &lt;button
                class="ti-btn btn-wave  ti-btn-warning !me-0 !rounded-e-none ti-dropdown-toggle"
                type="button" id="dropdownMenuButton1"
                aria-expanded="false"&gt;
                Action
            &lt;/button&gt;
            &lt;button
                class="ti-btn btn-wave  ti-btn-warning opacity-[0.85] !rounded-s-none "&gt;&lt;i
                    class="ri-arrow-down-s-line align-middle inline-block"&gt;&lt;/i&gt;&lt;/button&gt;
    ...
    &lt;div class="ti-btn-group !p-0 !border-0 !m-0"&gt;
        &lt;div class="hs-dropdown ti-dropdown"&gt;
            &lt;button
                class="ti-btn btn-wave  ti-btn-danger !me-0 !rounded-e-none ti-dropdown-toggle"
                type="button" id="dropdownMenuButton1"
                aria-expanded="false"&gt;
                Action
            &lt;/button&gt;
            &lt;button
                class="ti-btn btn-wave  ti-btn-danger opacity-[0.85] !rounded-s-none"&gt;&lt;i
                    class="ri-arrow-down-s-line align-middle inline-block"&gt;&lt;/i&gt;&lt;/button&gt;
                            ...
                            <div class="box-body">
                                <div class="hs-dropdown ti-dropdown [--placement:top-left] m-1">
                                    <button id="hs-dropup" type="button"
                                        class="hs-dropdown-toggle ti-dropdown-toggle ti-btn btn-wave  ti-btn-primary !py-2">
                                        Dropup
                                ...
                                <div class="ti-dropdown m-1">
                                    <button type="button"
                                        class="relative ti-dropdown-toggle ti-btn btn-wave !m-0 ti-btn-secondary !py-1 !rounded-e-none !me-0">
                                        Split dropup
                                    </button>
                                    <div class="hs-dropdown ti-dropdown [--placement:top-left]">
                                        <button id="hs-split-dropup" type="button"
                                            class="hs-dropdown-toggle relative ti-btn btn-wave  ti-btn-secondary !opacity-[0.85] !m-0 !rounded-s-none ti-dropdown-toggle">
                    ...
                    <div class="xl:col-span-6 col-span-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                <div class="hs-dropdown ti-dropdown [--placement:right-top] m-1">
                                    <button type="button"
                                        class="hs-dropdown-toggle relative ti-btn btn-wave  ti-btn-secondary !py-2 !rounded-e-none ti-dropdown-toggle !me-0">
                                        Split dropright
                                    </button>
                                    <div class="hs-dropdown ti-dropdown [--placement:right-top]">
                                        <button id="hs-split-dropright" type="button"
                                            class="hs-dropdown-toggle relative  ti-dropdown-toggle !opacity-[0.85] rounded-sm  ti-btn btn-wave  ti-btn-secondary !rounded-s-none">
                                            <span class="sr-only">Toggle Dropdown</span>
                                ...
                                <div class="hs-dropdown ti-dropdown [--placement:left-top] m-1">
                                    <div class="hs-dropdown ti-dropdown [--placement:left-top]">
                                        <button id="hs-split-dropright1" type="button"
                                            class="hs-dropdown-toggle relative  ti-dropdown-toggle !opacity-[0.85] rounded-sm ti-btn btn-wave !m-0 ti-btn-secondary !rounded-e-none">
                                            <span class="sr-only">Toggle Dropdown</span>
                                    ...
                                    <button type="button"
                                        class="hs-dropdown-toggle relative ti-btn btn-wave  ti-btn-secondary !m-0  !py-2 !rounded-s-none ti-dropdown-toggle !me-0">
                                        Split dropleft
                                    </button>
                                </div>
                            </div>
...
&lt;div class="hs-dropdown ti-dropdown [--placement:left-top]"&gt;
&lt;button id="hs-split-dropright" type="button"
    class="hs-dropdown-toggle relative  ti-dropdown-toggle !opacity-[0.85] rounded-none  ti-btn btn-wave  ti-btn-secondary   !rounded-s-none"&gt;
    &lt;span class="sr-only"&gt;Toggle Dropdown&lt;/span&gt;
    &lt;svg class="w-auto h-2.5 text-white" width="16" height="16"
        viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"&gt;
        &lt;path
                    ...
                    <div class="xl:col-span-6 col-span-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="hs-dropdown ti-dropdown">
                                    <button type="button"
                                        class="ti-btn btn-wave  ti-btn-primary ti-dropdown-toggle !py-2"
                                        aria-expanded="false">
                ...
                <div class="grid grid-cols-12 gap-x-6">
                    <div class="xl:col-span-3 col-span-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="hs-dropdown ti-dropdown">
                                    <button type="button" class="ti-btn-primary ti-dropdown-toggle !py-2"
                                        aria-expanded="false">
                                        Dropstart<i class="ri-arrow-down-s-line align-middle inline-block"></i>
                                    </button>
                                    <ul class="hs-dropdown-menu ti-dropdown-menu hidden">
                            ...
                            <div class="box-body">
                                <div class="ti-btn-list">
                                    <div class="ti-btn-group !p-0 !m-0 !border-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button class="ti-btn btn-wave  ti-btn-primary ti-dropdown-toggle"
                                                type="button" id="defaultDropdown" aria-expanded="false">
                                                Default dropdown<i
                                    ...
                                    <div class="ti-btn-group !p-0 !m-0 !border-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button class="ti-btn btn-wave  ti-btn-secondary ti-dropdown-toggle"
                                                type="button" id="dropdownMenuClickableOutside" aria-expanded="false">
                                                Clickable outside<i
                                                    class="ri-arrow-down-s-line align-middle inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !m-0 !border-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button class="ti-btn btn-wave  ti-btn-info ti-dropdown-toggle"
                                                type="button" id="dropdownMenuClickableInside" aria-expanded="false">
                                                Clickable inside<i
                                                    class="ri-arrow-down-s-line align-middle inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                                    ...
                                    <div class="ti-btn-group !p-0 !m-0 !border-0">
                                        <div class="hs-dropdown ti-dropdown">
                                            <button class="ti-btn btn-wave  ti-btn-warning ti-dropdown-toggle"
                                                type="button" id="dropdownMenuClickable" aria-expanded="false">
                                                Manual close<i
                                                    class="ri-arrow-down-s-line align-middle inline-block"></i>
                                            </button>
                                            <ul class="hs-dropdown-menu ti-dropdown-menu hidden"
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="hs-dropdown ti-dropdown [--auto-close:inside]">
                                    <button class="ti-btn ti-btn-secondary !py-2" id="hs-dropdown-auto-close-inside"
                                    ...
                                    <div class="hs-dropdown-menu ti-dropdown-menu hidden"
                                        ...
                                        <form class="!px-6 !py-4">
                                            <div class="mb-4">
                                                <label for="exampleDropdownFormEmail1" class="ti-form-label">Email
                                                    address</label>
                                            ...
                                            <div class="mb-4">
                                                <label for="exampleDropdownFormPassword1"
                                                    class="ti-form-label">Password</label>
                            ...
                            <div class="box-body">
                                <div class="">
                                    <div class="ti-dropdown hs-dropdown">
                                        <button class="ti-btn btn-wave  ti-btn-primary ti-dropdown-toggle mb-0 !py-2"
                                    ...
                                    <div class="ti-dropdown hs-dropdown">
                                        <button type="button"
                                            class="ti-btn btn-wave  ti-btn-secondary ti-dropdown-toggle mb-0 !py-2"
                                            aria-expanded="false">
                                            Right-aligned menu<i
                                                class="ri-arrow-down-s-line align-middle inline-block"></i>
                                        </button>
                                        <ul class="hs-dropdown-menu ti-dropdown-menu ti-dropdown-menu-end hidden ">
                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Menu item</a>
                                            </li>
                                            <li><a class="ti-dropdown-item" href="javascript:void(0);">Menu item</a>
                                            </li>
                                    ...
                                    <div class="ti-dropdown hs-dropdown" data-hs-dropdown-strategy="absolute">
                                        <button type="button" id="hs-dropdown-left-but-right-on-lg"
                                            class="ti-btn btn-wave  ti-btn-info ti-dropdown-toggle mb-0 !py-2"
                                            aria-expanded="false">
                                    ...
                                    <div class="ti-dropdown hs-dropdown" data-hs-dropdown-strategy="absolute">
                                        <button type="button" id="hs-dropdown-right-but-left-on-lg"
                                            class="ti-btn btn-wave  ti-btn-warning ti-dropdown-toggle mb-0 !py-2"
                                            aria-expanded="false">
                                    ...
                                    <div class="hs-dropdown ti-dropdown [--placement:left-top] m-1">
                                        <button id="hs-dropright2" type="button"
                                            class="hs-dropdown-toggle ti-dropdown-toggle ti-btn btn-wave  ti-btn-success !py-2">
                                            <svg class="w-auto h-2.5 text-white" width="16" height="16"
                                                viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M11 1L5.31305 7.16086C5.13625 7.35239 5.13625 7.64761 5.31305 7.83914L11 14"
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="ti-dropdown hs-dropdown">
                                    ...
                                    <ul
                                        class="hs-dropdown-menu ti-dropdown-menu bg-black text-white dark:text-black hidden">
                                        <li><a class="ti-dropdown-item !text-white dark:text-black bg-black"
                            ...
                            <div class="box-body">
                                <div class="ti-btn-list">
                                    <div class="ti-dropdown hs-dropdown">
                                        ...
                                        <ul class="hs-dropdown-menu ti-dropdown-menu !bg-primary hidden">
                                    ...
                                    <div class="ti-dropdown hs-dropdown">
                                        <button class="ti-btn btn-wave  ti-btn-secondary ti-dropdown-toggle !py-2"
                                            type="button" aria-expanded="false">
                                            secondary<i class="ri-arrow-down-s-line align-middle inline-block"></i>
                                        </button>
                                        <ul class="hs-dropdown-menu ti-dropdown-menu !bg-secondary hidden">
                                            <li><a class="ti-dropdown-item !text-white"
                                                    href="javascript:void(0);">Action</a></li>
                                            <li><a class="ti-dropdown-item !text-white"
                                                    href="javascript:void(0);">Another action</a></li>
                                    ...
                                    <div class="ti-dropdown hs-dropdown">
                                        <button class="ti-btn btn-wave  ti-btn-warning ti-dropdown-toggle !py-2"
                                            type="button" aria-expanded="false">
                                    ...
                                    <div class="ti-dropdown hs-dropdown">
                                        <button class="ti-btn btn-wave  ti-btn-info ti-dropdown-toggle !py-2"
                                            type="button" aria-expanded="false">
                                    ...
                                    <div class="ti-dropdown hs-dropdown">
                                        <button class="ti-btn btn-wave  ti-btn-success ti-dropdown-toggle !py-2"
                                            type="button" aria-expanded="false">
                                    ...
                                    <div class="ti-dropdown hs-dropdown">
                                        <button class="ti-btn btn-wave  ti-btn-danger ti-dropdown-toggle !py-2"
                                            type="button" aria-expanded="false">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="ti-btn-list">
                                    ...
                                    <div class="ti-dropdown hs-dropdown">
                                        <button type="button"
                                            class="ti-btn btn-wave  ti-btn-ghost-info ti-dropdown-toggle !py-2 !shadow-none"
                                            aria-expanded="false">
                                            Info<i class="ri-arrow-down-s-line align-middle inline-block"></i>
                                        </button>
                                        <ul class="hs-dropdown-menu ti-dropdown-menu hidden">
                ...
                <div class="grid grid-cols-12 gap-x-6">
                    <div class="xl:col-span-6 col-span-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <p class=" mb-3">Use <code class="!text-[#d63384]">.ti-dropdown-item-text.</code> to
                                    create non-interactive
                                    dropdown items.</p>
                                <div class="bd-example">
                                    <ul
                                        class="dropdown-menu border dark:border-defaultborder/10 shadow-sm p-2 rounded-sm">
...
&lt;/div&gt;</code></pre>
                    ...
                    <div class="xl:col-span-6 col-span-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <p class="card-titlte mb-3">Add a <code class="!text-[#d63384]">.dropdown-header</code>
                                    to label sections of
                                    actions in any dropdown menu.</p>
                                <div class="bd-example">
                                    <ul class="dropdown-menu border dark:border-defaultborder/10 shadow-sm rounded-sm">
                                        <li>
                    ...
                    <div class="xl:col-span-6 col-span-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="bd-example">
                                    <div
                                        class="dropdown-menu border dark:border-defaultborder/10 shadow-sm p-6 !rounded-sm text-[#8c9097] dark:text-white/50 text-[0.875rem] max-w-[200px]">
                                        <p class="mb-4">
