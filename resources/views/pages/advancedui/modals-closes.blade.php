                ...
                <div class="container-fluid">
                    ...
                    <div class="flex items-center justify-between page-header-breadcrumb flex-wrap gap-2">
                        <div>
                            ...
                            <h1 class="page-title font-medium text-lg mb-0">Modal & Closes</h1>
                        </div>
                        <div class="btn-list">
                     ...
                     <div class="grid grid-cols-12 gap-x-6">
                      <div class="xl:col-span-6 col-span-12">
                          <div class="box custom-box">
                              ...
                              <div class="box-body">
                                    <a href="javascript:void(0);" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-primary" data-hs-overlay="#todo-compose">Launch demo modal
                                    </a>
                                        ...
                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                                          <div class="ti-modal-content">
                                            ...
                                            <div class="ti-modal-footer">
                                                <button type="button"
                                                class="hs-dropdown-toggle ti-btn  btn-wave  ti-btn-secondary align-middle"
...
<!-- Prism Code -->
                      ...
                      <div class="xl:col-span-6 col-span-12">
                          <div class="box custom-box">
                              ...
                              <div class="box-body">
                                    <a href="javascript:void(0);" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-primary " data-hs-overlay="#staticBackdrop">Launch static backdrop modal
                                    </a>
...
<!-- Prism Code -->
                      ...
                      <div class="xl:col-span-6 col-span-12">
                          <div class="box custom-box">
                              ...
                              <div class="box-body">
                                <a href="javascript:void(0);" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-primary" data-hs-overlay="#exampleModalScrollable"> Scrolling long content
                                </a>
                  ...
                  <div class="grid grid-cols-12 gap-x-6">
                      <div class="xl:col-span-6 col-span-12">
                          <div class="box custom-box">
                              ...
                              <div class="box-body">
                                  <button type="button" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-primary" data-hs-overlay="#hs-vertically-centered-scrollable-modal">
                                    ...
                                    <div id="hs-vertically-centered-scrollable-modal" class="hs-overlay hidden ti-modal">
                                      <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out h-[calc(100%-3.5rem)] min-h-[calc(100%-3.5rem)] flex items-center">
                                        <div class="max-h-full overflow-hidden ti-modal-content">
                                          ...
                                          <div class="ti-modal-footer">
                                            <button type="button" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-secondary" data-hs-overlay="#hs-vertically-centered-scrollable-modal">
                                              Close
                                            </button>
                                            <a class="ti-btn  btn-wave ti-btn-primary" href="javascript:void(0);">
                                              Save changes
...
<!-- Prism Code -->
                      ...
                      <div class="xl:col-span-6 col-span-12">
                          <div class="box custom-box">
                              ...
                              <div class="box-body">
                                  <button type="button" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-primary" data-hs-overlay="#exampleModalScrollable4">
                                      Launch demo modal
                                    </button>
                                  <div id="exampleModalScrollable4" class="hs-overlay hidden ti-modal">
                                      <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out min-h-[calc(100%-3.5rem)] flex items-center">
                                        <div class="ti-modal-content w-full">
                                          ...
                                          <div class="ti-modal-body">
                                              ...
                                              <div>
                                                <div class="hs-tooltip ti-main-tooltip">
                                                  <a href="javascript:void(0);" class="hs-tooltip-toggle text-primary">
                                                     This Link
                                                      <span
                                          ...
                                          <div class="ti-modal-footer">
                                            <button type="button" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-secondary" data-hs-overlay="#exampleModalScrollable4">
                                              Close
                                            </button>
                                            <a class="ti-btn  btn-wave ti-btn-primary" href="javascript:void(0);">
                                              Save changes
                ...
                &lt;p class="text-muted mb-0"&gt;
                    &lt;a href="javascript:void(0);"&gt;
                      &lt;span class="hs-tooltip-toggle !text-primary"&gt;
                        This link
                          &lt;span
                              class=" !font-medium !text-white shadow-sm"
                              role="tooltip"&gt;
                              Tooltip
                          &lt;/span&gt;
                      &lt;/span&gt;
...
<!-- Prism Code -->
                      ...
                      <div class="xl:col-span-6 col-span-12">
                          <div class="box custom-box">
                              ...
                              <div class="box-body">
                                  <button type="button" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-primary" data-hs-overlay="#hs-toggle-between-modals-first-modal">
                                      Open first modal
                                  </button>
                                    <div id="hs-toggle-between-modals-first-modal" class="hs-overlay hidden ti-modal">
                                      <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                                        <div class="ti-modal-content">
                                          ...
                                          <div class="ti-modal-body">
                                            <p class="mt-1 text-gray-800 text-textmuted dark:text-textmuted/50">
                                              Show a second modal and hide this one with the button below.
                                            </p>
                                          </div>
                                          <div class="ti-modal-footer">
                                            <button type="button" class="ti-btn  btn-wave ti-btn-primary" data-hs-overlay="#hs-toggle-between-modals-second-modal">
                                              Open second modal
                                            </button>
                                          </div>
                                        </div>
                                    ...
                                    <div id="hs-toggle-between-modals-second-modal" class="hs-overlay hidden ti-modal">
                                      <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                                        <div class="ti-modal-content">
                                          ...
                                          <div class="ti-modal-footer">
                                            <button type="button" class="ti-btn  btn-wave ti-btn-primary" data-hs-overlay="#hs-toggle-between-modals-first-modal">
                                              Back to first
                                            </button>
                                          </div>
                                        </div>
                  ...
                  <div class="grid grid-cols-12 gap-x-6">
                    <div class="xl:col-span-6 col-span-12">
                      <div class="box">
                        ...
                        <div class="box-body">
                          <button type="button" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-primary" data-hs-overlay="#hs-slide-up-animation-modal">
                            Open modal
                          </button>
                          ...
                          <div id="hs-slide-up-animation-modal" class="hs-overlay hidden ti-modal">
                            <div class="hs-overlay-open:!mt-7 !mt-14 ease-out ti-modal-box">
                              <div class="ti-modal-content">
                                ...
                                <div class="ti-modal-footer">
                                  <button type="button" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-secondary" data-hs-overlay="#hs-slide-up-animation-modal">
                                    Close
                                  </button>
                                  <a class="ti-btn  btn-wave ti-btn-primary" href="javascript:void(0);">
                                    Save changes
                    ...
                    <div class="xl:col-span-6 col-span-12">
                      <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                              <div class="ti-modal-content pointer-events-auto">
                                ...
                                <div class="ti-modal-body">
                                  ...
                                  <button type="button" class="ti-btn  btn-wave ti-btn-primary" data-hs-overlay="#hs-stacked-overlays-2" data-hs-overlay-options="{
                                    &quot;isClosePrev&quot;: false
                                  }">
                                    Open modal
                                  </button>
                                ...
                                <div class="ti-modal-footer">
                                  <button type="button" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-secondary" data-hs-overlay="#hs-stacked-overlays">
                                    Close
                                  </button>
                          ...
                          <div id="hs-stacked-overlays-2" class="hs-overlay hs-overlay-backdrop-open:bg-gray-900/70 hidden ti-modal pointer-events-none">
                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                              <div class="ti-modal-content pointer-events-auto">
                                <div class="ti-modal-header">
                                  <h6 class="ti-modal-title">
                                ...
                                <div class="ti-modal-body">
                                  ...
                                  <button type="button" class="ti-btn  btn-wave ti-btn-primary" data-hs-overlay="#hs-stacked-overlays-3" data-hs-overlay-options="{
                                    &quot;isClosePrev&quot;: false
                                  }">
                                    Open modal
                                  </button>
                                ...
                                <div class="ti-modal-footer">
                                  <button type="button" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-secondary" data-hs-overlay="#hs-stacked-overlays-2" data-hs-overlay-options="{
                                    &quot;isClosePrev&quot;: false
                                  }">
                                    Close
                                  </button>
                          ...
                          <div id="hs-stacked-overlays-3" class="hs-overlay hs-overlay-backdrop-open:bg-gray-900/80 hidden ti-modal z-[80] pointer-events-none">
                            <div class="hs-overlay-open:mt-7 ti-modal-box ease-out">
                              <div class="ti-modal-content pointer-events-auto ">
                                ...
                                <div class="ti-modal-footer">
                                  <button type="button" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-secondary" data-hs-overlay="#hs-stacked-overlays-3" data-hs-overlay-options="{
                                    &quot;isClosePrev&quot;: false
                                  }">
                                    Close
                                  </button>
                    ...
                    <div class="xl:col-span-6 col-span-12">
                      <div class="box">
                        ...
                        <div class="box-body">
                          ...
                          <div id="hs-custom-backdrop-modal" class="hs-overlay hs-overlay-backdrop-open:bg-primary/50 hidden ti-modal z-[101] pointer-events-none">
                            <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                              <div class="ti-modal-content pointer-events-auto">
                                <div class="ti-modal-header">
                                  <h6 class="ti-modal-title">
                                ...
                                <div class="ti-modal-footer">
                                  <button type="button" class="hs-dropdown-toggle hs-dropdown-toggle ti-btn  btn-wave ti-btn-secondary" data-hs-overlay="#hs-custom-backdrop-modal">
                                    Close
                                  </button>
                                  <a class="ti-btn  btn-wave ti-btn-primary" href="javascript:void(0);">
                                    Save changes
                  ...
                  <div class="grid grid-cols-12 gap-x-6">
                      <div class="xl:col-span-12 col-span-12">
                          <div class="box custom-box">
                              ...
                              <div class="box-body">
                                  <button type="button" class="m-1 ms-0 ti-btn  btn-wave ti-btn-primary" data-hs-overlay="#hs-full-screen-modal">
                                    Full screen
                                  </button>
                                  <div id="hs-full-screen-modal" class="hs-overlay hidden size-full fixed top-0 start-0 z-[999] overflow-x-hidden overflow-y-auto pointer-events-none" role="dialog" tabindex="-1" aria-labelledby="hs-full-screen-label">
                                    <div class="hs-overlay-open:mt-0 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-10 opacity-0 transition-all max-w-full max-h-full h-full">
                                      <div class="flex flex-col bg-white pointer-events-auto max-w-full max-h-full h-full dark:bg-neutral-800">
                                        <div class="ti-modal-header flex justify-between items-center py-3 px-4 border-b dark:border-neutral-700">
                                          <h6 id="hs-full-screen-label" class="ti-modal-title">
                                            Full Screen Modal
                                          </h6>
                                        ...
                                        <div class="ti-modal-body p-4 overflow-y-auto">
                                          <p class="mt-1 text-gray-800 text-textmuted dark:text-textmuted/50">
                                            ...
                                          </p>
                                        </div>
                                        <div class="ti-modal-footer flex justify-end items-center gap-x-2 py-3 px-4 mt-auto border-t dark:border-neutral-700">
                                          <button type="button" class="hs-dropdown-toggle ti-btn btn-wave ti-btn-secondary" data-hs-overlay="#hs-full-screen-modal">
                                            Close
                                          </button>
                                        </div>
                                      </div>
                                  ...
                                  <button type="button" class="m-1 ms-0 ti-btn  btn-wave ti-btn-secondary"  data-hs-overlay="#hs-full-screen-modal-below-sm">
                                  ...
                                  <div id="hs-full-screen-modal-below-sm" class="hs-overlay hidden ti-modal">
                                    <div class="hs-overlay-open:mt-0 ti-modal-box mt-10 max-w-full w-full !m-0 sm:hs-overlay-open:!mt-10 sm:!mt-0 sm:max-w-lg sm:!mx-auto">
                                      <div class="ti-modal-content sm:border sm:rounded-sm sm:shadow-sm dark:bg-bodybg sm:dark:border-white/10">
                                        ...
                                        <div class="ti-modal-footer">
                                          <button type="button" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-secondary" data-hs-overlay="#hs-full-screen-modal-below-sm">
                                              Close
                                            </button>
                                        </div>
                                      </div>
                                  ...
                                  <button type="button" class="m-1 ms-0 ti-btn  btn-wave ti-btn-warning" data-hs-overlay="#hs-full-screen-modal-below-md">
                                  ...
                                  <div id="hs-full-screen-modal-below-md" class="hs-overlay hidden ti-modal">
                                    <div class="hs-overlay-open:mt-0 ti-modal-box mt-10 !max-w-full w-full !m-0 md:hs-overlay-open:!mt-10 md:!mt-0 md:!max-w-lg md:!mx-auto">
                                      <div class="ti-modal-content md:border md:rounded-sm md:shadow-sm md:dark:border-white/10">
                                        ...
                                        <div class="ti-modal-footer">
                                          <button type="button" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-secondary" data-hs-overlay="#hs-full-screen-modal-below-md">
                                              Close
                                            </button>
                                        </div>
                                      </div>
                                  ...
                                  <button type="button" class="m-1 ms-0 ti-btn  btn-wave ti-btn-secondary" data-hs-overlay="#hs-full-screen-modal-below-lg">
                                  ...
                                  <div id="hs-full-screen-modal-below-lg" class="hs-overlay hidden ti-modal">
                                    <div class="hs-overlay-open:mt-0 ti-modal-box mt-10 !max-w-full w-full !m-0 lg:hs-overlay-open:!mt-10 lg:!mt-0 lg:!max-w-lg lg:!mx-auto">
                                      <div class="ti-modal-content lg:border lg:rounded-sm lg:shadow-sm lg:dark:border-white/10">
                                        ...
                                        <div class="ti-modal-footer">
                                          <button type="button" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-secondary" data-hs-overlay="#hs-full-screen-modal-below-lg">
                                              Close
                                            </button>
                                        </div>
                                      </div>
                                  ...
                                  <button type="button" class="m-1 ms-0 ti-btn  btn-wave ti-btn-success" data-hs-overlay="#hs-full-screen-modal-below-xl">
                                  ...
                                  <div id="hs-full-screen-modal-below-xl" class="hs-overlay hidden ti-modal">
                                    <div class="hs-overlay-open:mt-0 ti-modal-box mt-10 !max-w-full w-full !m-0  xl:hs-overlay-open:!mt-10 xl:!mt-0 xl:!max-w-xl xl:!mx-auto">
                                      <div class="ti-modal-content xl:border xl:rounded-sm xl:shadow-sm xl:dark:border-white/10">
                                        ...
                                        <div class="ti-modal-footer">
                                          <button type="button" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-secondary" data-hs-overlay="#hs-full-screen-modal-below-xl">
                                              Close
                                            </button>
                                        </div>
                                      </div>
                                  ...
                                  <button type="button" class="m-1 ms-0 ti-btn  btn-wave ti-btn-danger" data-hs-overlay="#hs-full-screen-modal-below-xxl">
                                    ...
                                    <div class="hs-overlay-open:mt-0 ti-modal-box mt-10 !max-w-full w-full !m-0  xxl:hs-overlay-open:!mt-10 xxl:!mt-0 xxl:!max-w-xl xxl:!mx-auto">
                                      <div class="ti-modal-content xxl:border xxl:rounded-sm xxl:shadow-sm xxl:dark:border-white/10">
                                        <div class="ti-modal-header">
                                          ...
                                          <button type="button" class="hs-dropdown-toggle ti-modal-close-btn" data-hs-overlay="#hs-full-screen-modal-below-xxl">
                                            <span class="sr-only">Close</span>
                                            <svg class="w-3.5 h-3.5" width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              <path d="M0.258206 1.00652C0.351976 0.912791 0.479126 0.860131 0.611706 0.860131C0.744296 0.860131 0.871447 0.912791 0.965207 1.00652L3.61171 3.65302L6.25822 1.00652C6.30432 0.958771 6.35952 0.920671 6.42052 0.894471C6.48152 0.868271 6.54712 0.854471 6.61352 0.853901C6.67992 0.853321 6.74572 0.865971 6.80722 0.891111C6.86862 0.916251 6.92442 0.953381 6.97142 1.00032C7.01832 1.04727 7.05552 1.1031 7.08062 1.16454C7.10572 1.22599 7.11842 1.29183 7.11782 1.35822C7.11722 1.42461 7.10342 1.49022 7.07722 1.55122C7.05102 1.61222 7.01292 1.6674 6.96522 1.71352L4.31871 4.36002L6.96522 7.00648C7.05632 7.10078 7.10672 7.22708 7.10552 7.35818C7.10442 7.48928 7.05182 7.61468 6.95912 7.70738C6.86642 7.80018 6.74102 7.85268 6.60992 7.85388C6.47882 7.85498 6.35252 7.80458 6.25822 7.71348L3.61171 5.06702L0.965207 7.71348C0.870907 7.80458 0.744606 7.85498 0.613506 7.85388C0.482406 7.85268 0.357007 7.80018 0.264297 7.70738C0.171597 7.61468 0.119017 7.48928 0.117877 7.35818C0.116737 7.22708 0.167126 7.10078 0.258206 7.00648L2.90471 4.36002L0.258206 1.71352C0.164476 1.61976 0.111816 1.4926 0.111816 1.36002C0.111816 1.22744 0.164476 1.10028 0.258206 1.00652Z" fill="currentColor"/>
                                            </svg>
                                        ...
                                        <div class="ti-modal-footer">
                                          <button type="button" class="hs-dropdown-toggle ti-btn  btn-wave ti-btn-secondary" data-hs-overlay="#hs-full-screen-modal-below-xxl">
                                              Close
                                            </button>
                                        </div>
                                      </div>
